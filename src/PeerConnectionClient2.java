...
public class PeerConnectionClient2 {
	...
	private static final PeerConnectionClient2 instance = new PeerConnectionClient2();
...
//	}
	...
	public static PeerConnectionClient2 getInstance() {
		return instance;
	}

//	public static PeerConnectionFactory getInstanceFactory(EglBase.Context context) {
//		if (factory == null) {
...
//	}
	...
	public void createPeerConnectionFactory(PeerConnectionFactory factory, final EglBase.Context context,
...
//		createPeerConnection(renderEGLContext, localRender, remoteRender),videoCapturer, signalingParameters);
//	}
...
//	}
	 ...
	 */
	public void createPeerConnection(final EglBase.Context eglContext,
	                                 final VideoRenderer.Callbacks localRender, final VideoRenderer.Callbacks remoteRender,
		...
		executor.execute(new Runnable() {
			...
			public void run() {
				createMediaConstraintsInternal();
				createPeerConnectionInternal(eglContext);
			}
		});
	}
	...
	private void createPeerConnectionFactoryInternal(EglBase.Context context) {
//		PeerConnectionFactory.initializeInternalTracer();/*d*/
...
//		PeerConnectionFactory.initializeFieldTrials(fieldTrials);/*d*/
	...
	private class PCObserver implements PeerConnection.Observer {
		...
		public void onAddStream(final MediaStream stream) {
			...
			executor.execute(new Runnable() {
				@Override
				public void run() {
					Log.d(TAG, "onAddStream1");
					if (peerConnection == null || isError) {
						return;
					}
					Log.d(TAG, "onAddStream2");
					if (stream.audioTracks.size() > 1 || stream.videoTracks.size() > 1) {
						reportError("Weird-looking stream: " + stream);
						return;
					}
					Log.d(TAG, "onAddStream3");
...
//				}
			...
			videoCapturer = createCameraCapturer(new Camera1Enumerator(false/*纹理*/));
		}
		if (videoCapturer == null) {
			reportError("Failed to open camera");
			return null;
